...
public class Controller {
    ...
    public static void addMedlem(String navn, String køn, int fødselsdato, int telefonNummer, String medlemstype, boolean juniorEllerSenior, boolean motionistEllerKonku,boolean restance, String svømmediscipln, String stævne, int tid, int placering) {
        nyMedlemsListe.addMedlem(navn, køn, fødselsdato, telefonNummer, medlemstype, juniorEllerSenior, motionistEllerKonku, restance, svømmediscipln, stævne, tid, placering);
    }
